...
public class JfrReader implements Closeable {
    ...
    public final Map<String, JfrClass> typesByName = new Object2ObjectOpenHashMap<>();
    public final Long2ObjectMap<String> threads = new Long2ObjectOpenHashMap<>(); // spark
    ...
    public final Int2ObjectMap<String> frameTypes = new Int2ObjectOpenHashMap<>();
    public final Int2ObjectMap<String> threadStates = new Int2ObjectOpenHashMap<>();
    public final Map<String, String> settings = new Object2ObjectOpenHashMap<>();
